    ...
    public function boot()
    {
        ...
        View::composer(['crm::*'], function ($view) {
            if (auth()->check()) {
                ...
                $view->with('news_categories', NewsCategory::where('business_id', $business_id)->get());
                $view->with('news_articles', News::where('business_id', $business_id)->orderBy('created_at', 'desc')->get());
            }
        });
    }
