...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        // Let Laravel resolve the controller on-the-fly and return its create view
        return redirect()->route('online_sales');
    }
    ...
    public function onlineSales() {
        ...
        return app('Modules\Crm\Http\Controllers\OrderRequestController')->create();
    }
