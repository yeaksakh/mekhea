...
Route::middleware('web', 'authh', 'SetSessionData', 'auth', 'language', 'timezone', 'ContactSidebarMenu', 'CheckContactLogin')->prefix('contact')->group(function () {
    Route::get('dashboard', [\Modules\Crm\Http\Controllers\DashboardController::class, 'dashboard']);
    ...
    Route::get('contact/profile-modal', [Modules\Crm\Http\Controllers\ManageProfileController::class, 'getProfileModal']);
...
Route::middleware('web', 'authh', 'SetSessionData', 'auth', 'language', 'timezone', 'ContactSidebarMenu', 'CheckContactLogin')->group(function () {
    Route::get('online-sales', [\Modules\Crm\Http\Controllers\DashboardController::class, 'onlineSales'])->name('online_sales');
});
