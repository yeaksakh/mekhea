<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('announcement::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            $fileExtension = strtolower(pathinfo($announcement->category->image, PATHINFO_EXTENSION));
            @endphp

            @if(in_array($fileExtension, $imageExtensions))
            <div class="profile-image">
                <img src="{{ asset('uploads/AnnouncementCategory/' . basename($announcement->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/AnnouncementCategory/' . basename($announcement->category->image)) }}" target="_blank">
            ...
            <div class="profile-info">
                ...
                <p>{!! $announcement->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="title_1content">
    <h4>@lang('announcement::lang.title_1')</h4>
    <p>{{ $announcement->title_1 }}</p>
</div>
<div class="profile-section" id="description_2content">
    <h4>@lang('announcement::lang.description_2')</h4>
    <p>{{ $announcement->description_2 }}</p>
</div>
<div class="profile-section" id="date_3content">
    <h4>@lang('announcement::lang.date_3')</h4>
    <p>{{ $announcement->date_3 }}</p>
</div>
        <!-- Additional Sections -->
        ...
        <div class="profile-section" id="qrcontent">
            <h4>@lang('announcement::lang.qrcode')</h4>
