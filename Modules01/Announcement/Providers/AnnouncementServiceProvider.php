...
{
    protected string $moduleName = 'Announcement';
    protected string $moduleNameLower = 'announcement';

    protected $middleware = [
        'Announcement' => [
            'AnnouncementLanguage' => 'ModuleLanguageMiddleware',
        ],
    ];
    ...
    protected function registerCommandSchedules()
    {
        ...
        /**
     * Register business info view composer for all views
     */
