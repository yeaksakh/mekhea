<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('backup::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/BackupCategory/' . basename($backup->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/BackupCategory/' . basename($backup->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $backup->category->name }}</h3>
                <p>{!! $backup->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="name_1content">
    <h4>@lang('backup::lang.name_1')</h4>
    <p>{{ $backup->name1->first_name . ' ' . $backup->name1->last_name }}</p>
</div>
        <!-- Additional Sections -->
