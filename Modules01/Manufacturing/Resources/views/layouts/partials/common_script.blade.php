	    ...
	    productions_table = $('#productions_table').DataTable({
	        ...
	        fnDrawCallback: function(oSettings) {
				...
				// Calculate totals
					...
					$('#productions_table tbody tr').each(function() {
						var quantity = parseFloat($(this).find('td:eq(4)').text()) || 0;
						var cost = parseFloat($(this).find('td:eq(5)').text().replace(/[^0-9.-]+/g,"")) || 0;
					...
					$('#total_cost').text(__currency_trans_from_en(totalCost, true));
	        }
	    });
