<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        {!! Form::open(['url' => action([\Modules\AutoAudit\Http\Controllers\AutoAuditController::class, 'store']), 'method' => 'post', 'id' => 'add_AutoAudit_form' ]) !!}
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">@lang('autoaudit::lang.add_AutoAudit')</h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="autoaudit_category_id" name="autoaudit_category_id" style="width: 100%;">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="transaction_id" name="transaction_id" step="any">
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
            <label for="audit_status_2">@lang('autoaudit::lang.audit_status_2'):</label>
            <input type="text" class="form-control" id="audit_status_2" name="audit_status_2">
        </div>
    </div>
