<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('autoaudit::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/AutoAuditCategory/' . basename($autoaudit->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/AutoAuditCategory/' . basename($autoaudit->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $autoaudit->category->name }}</h3>
                <p>{!! $autoaudit->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="transaction_idcontent">
    <h4>@lang('autoaudit::lang.transaction_id')</h4>
    <p>{{ $autoaudit->transaction_id }}</p>
</div>
<div class="profile-section" id="audit_status_2content">
    <h4>@lang('autoaudit::lang.audit_status_2')</h4>
    <p>{{ $autoaudit->audit_status_2 }}</p>
</div>
        <!-- Additional Sections -->
        ...
        <div class="profile-section" id="createdatcontent">
            ...
            <p>{{ $autoaudit->created_at }}</p>
        </div>

        <!-- QR Code Section -->
        <div class="profile-section" id="qrcontent">
            <h4>@lang('autoaudit::lang.qrcode')</h4>
