...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'modulecreatemodule';
        $this->appVersion = config('modulecreatemodule.module_version');
        $this->module_display_name = 'ModuleCreateModule';
    }
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => 'ModuleCreateModule', '--force' => true]);
            System::addProperty($this->module_name . '_version', $this->appVersion);
        }

        $action_url = action([\Modules\ModuleCreateModule\Http\Controllers\InstallController::class, 'install']);
        $intruction_type = 'uf';
        $action_type = 'install';
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = [
                'success' => 1,
                'msg' => 'ModuleCreateModule module updated successfully to version ' . $this->appVersion . ' !!',
            ];
    ...
    public function install()
    {
        try {
            ...
            Artisan::call('migrate', [
                '--path' => 'Modules/ModuleCreateModule/Database/Migrations',
                '--force' => true
            ]);

            // Publish module assets or configurations
            Artisan::call('module:publish', ['module' => 'ModuleCreateModule']);
            ...
            $output = ['success' => 1, 'msg' => 'ModuleCreateModule module installed successfully'];
        } catch (\Exception $e) {
