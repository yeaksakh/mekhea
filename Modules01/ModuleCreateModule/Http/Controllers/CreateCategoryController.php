...
class CreateCategoryController extends Controller
{
    ...
    public function createCreateCategory($moduleName)
    {
        // Your function implementation here
        // Example content creation code
        $viewPath = base_path("Modules/{$moduleName}/Resources/views/Category/create.blade.php");
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">@lang('{$moduleNameLower}::lang.add_category')</h4>
                    </div>
                    <div class="modal-body">
                        <form id="category_add_form" method="POST" action="{{ route('{$moduleName}-categories.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                    <label for="name">@lang('{$moduleNameLower}::lang.name'):</label>                     
                                ...
                                <div class="col-md-12">
                                <div class="form-group">                     
                                    <label for="description">@lang('{$moduleNameLower}::lang.description'):</label>                     
