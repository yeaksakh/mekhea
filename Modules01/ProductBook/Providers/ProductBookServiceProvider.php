...
namespace Modules\ProductBook\Providers;
...
class ProductBookServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'ProductBook';
    protected string $moduleNameLower = 'productbook';

    protected $middleware = [
        'ProductBook' => [
            'ProductBookLanguage' => 'ModuleLanguageMiddleware',
        ],
    ];
    ...
    protected function publishAssets(): void
    {
        ...
        // In local development, copy assets to public for immediate availability
