    ...
    purchase_table = $('#purchase_table').DataTable({
        ...
        columns: [
            { 
                ...
                orderable: false, 
                searchable: false, 
                visible: isViewMode ? visibleColumnNames.includes("Detail") || visibleColumnNames.includes("លំអិត") : true 
            },
            { 
            ...
            { 
                ...
                name: 'ref_no',  
                searchable: false, 
                visible: isViewMode ? visibleColumnNames.includes("Reference No") || visibleColumnNames.includes("លេខ") : true 
            },
            { 
                data: 'location_name', 
                name: 'BS.name', 
                visible: isViewMode ? visibleColumnNames.includes("Location") || visibleColumnNames.includes("ទីតាំងសាខា") : true 
            },
            { 
                data: 'name', 
                name: 'contacts.name', 
                visible: isViewMode ? visibleColumnNames.includes("Supplier") || visibleColumnNames.includes("អ្នកផ្គត់ផ្គង់") : true 
            },
            { 
                data: 'status', 
                name: 'status', 
                visible: isViewMode ? visibleColumnNames.includes("Purchase Status") || visibleColumnNames.includes("ស្ថានទិញចូល") : true 
            },
            { 
                data: 'payment_status', 
                name: 'payment_status', 
                visible: isViewMode ? visibleColumnNames.includes("Payment Status") || visibleColumnNames.includes("ស្ថានភាពការបង់ប្រាក់") : true 
            },
            { 
                data: 'final_total', 
                name: 'final_total',  
                visible: isViewMode ? visibleColumnNames.includes("Grand Total") || visibleColumnNames.includes("សរុប") : true 
            },
            { 
                data: 'payment_due', 
                name: 'payment_due', 
                orderable: false, 
                searchable: false,  
                visible: isViewMode ? visibleColumnNames.includes("Payment due") || visibleColumnNames.includes("កំណត់ថ្ងៃបង់ប្រាក់") : true 
            },
            { 
                data: 'added_by', 
                name: 'u.first_name',  
