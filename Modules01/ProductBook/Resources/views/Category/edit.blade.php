...
<div class="modal-content">
    ...
    <div class="modal-body">
        {!! Form::model($category, ['url' => action([\Modules\ProductBook\Http\Controllers\ProductBookController::class, 'updateCategory'], $category->id), 'method' => 'put', 'id' => 'category_edit_form' ]) !!}
        <div class="form-group">
            {!! Form::label('name', __('productbook::lang.name') . ':*') !!}
            {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => __('productbook::lang.category_name')]) !!}
        </div>
        <div class="form-group">
            {!! Form::label('image', __('productbook::lang.image') . ':') !!}
            {!! Form::file('image', [
                'id' => 'image',
            ...
            @if($category->{'image'})
                @php
                    ...
                    $filePath = 'uploads/ProductBookCategory/' . basename($category->{'image'});
                @endphp
        ...
        <div class="form-group">
            {!! Form::label('description', __('productbook::lang.description') . ':') !!}
            {!! Form::textarea('description', null, ['class' => 'form-control','id'=>'summernote', 'placeholder' => __('productbook::lang.description'), 'rows' => 3]) !!}
        </div>
