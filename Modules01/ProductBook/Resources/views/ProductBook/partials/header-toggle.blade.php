...
<div id="dynamicHeaderContainer">
    ...
    <div id="header1Container" style="display: block;">
        @include('productbook::ProductBook.partials.reportheader', [
    ...
    <div id="header2Container" style="display: none;">
        @include('productbook::ProductBook.partials.mony_report_header', [
            'report_name' => $reportName,
            'print_by' => $printBy,
            'assign_to' => $assignTo,
            'extra_fields' => $extraFields,
...
window.addEventListener('load', function() {
    ...
    function initializeHeader() {
        console.log('Initializing header with selection:', selectedHeader); // Debug log
