            ...
            const YeaksaMemberEditor = {
                ...
                defaultPositions: {
                    ...
                    certificateMemberpersonalDetails: [
                        ...
                        { tag: 'div', class: 'certificate-of-yeaksa-member-editor-text-element certificate-of-yeaksa-member-editor-category-certificateMemberpersonalDetails', style: { left: '170px', top: '780px', fontSize: '12px', fontFamily: "'Times New Roman', Moul, serif !important", color: '#000000', zIndex: '1', transform: 'none' }, text: "@lang('customercardb1::lang.register_date'): <?php echo htmlspecialchars($contact->register_date ? \Carbon\Carbon::parse($contact->register_date)->format('d-m-Y') : '-'); ?>", id: 'certificateMemberpersonalDetails-6' },
                        { tag: 'div', class: 'certificate-of-yeaksa-member-editor-text-element certificate-of-yeaksa-member-editor-category-certificateMemberpersonalDetails', style: { left: '465px', top: '780px', fontSize: '12px', fontFamily: "'Times New Roman', Moul, serif !important", color: '#000000', zIndex: '1', transform: 'none' }, text: "@lang('customercardb1::lang.expired_at'): <?php echo htmlspecialchars($contact->expired_date ? \Carbon\Carbon::parse($contact->expired_date)->format('d-m-Y') : '-'); ?>", id: 'certificateMemberpersonalDetails-7' },
                        ...
                        downloadBtn.onclick = () => {
                            ...
                            clone.querySelectorAll('.certificate-of-yeaksa-member-editor-text-element, .certificate-of-yeaksa-member-editor-image-element, .certificate-of-yeaksa-member-editor-qr-element').forEach(el => {
                                ...
                                if (isTextElement) {
                                    ...
                                    if (el.id === 'certificateMemberpersonalDetails-0' || el.id === 'certificateMemberpersonalDetails-1' || el.id === 'certificateMemberpersonalDetails-3' || el.id === 'certificateMemberpersonalDetails-4' || el.id === 'certificateMemberpersonalDetails-5') {
