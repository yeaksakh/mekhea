    ...
    <div class="fc_unique_wrapper">
        ...
        <div class="print-container" id="fc_unique_area">
            ...
            <div class="container">
                ...
                <div class="pl-5 my-2">
                    <span class="font-bold">ប្រការទី១៣</span> ៖ ភាគី”ខ” ប្រព័ន្ឋគ្រប់គ្រងហាងនេះនឹងតម្រូវអោយសាកល្បងប្រើប្រាស់រយះពេល6ខែដោយមិនគិតថ្លៃ និង គិតចាប់ពីខែទី7 ក្នុងមួយខែ៩ដុល្លារ រឺ 70ដុល្លារក្នុង1ឆ្នាំសម្រាប់ការថែទាំប្រព័ន្ធ។
                </div>
