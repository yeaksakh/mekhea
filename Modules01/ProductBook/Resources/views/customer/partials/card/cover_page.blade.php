...
<head>
    ...
    <style>
        ...
        .pspt_Page2_card-content .pspt_Page2_card-bg {
            position: absolute;
            inset: 0;
            width: 100%;
            height: 100%;
        ...
        /* Rotate card 3 and 4 by 180deg as requested */
        #p2_card3, #p2_card4 {
            transform: rotate(180deg);
            ...
            <div class="pspt_Page2_category-content" id="p2_background-controls">
                <div class="pspt_Page2_filter-group">
                    ...
                    <select class="pspt_Page2_background-dropdown" id="p2_backgroundDropdown"
                        ...
                        <option value="" selected disabled>ជ្រើសរើសកាត</option>
                        <option value="p2_card1">កាត ១</option>
                        <option value="p2_card2">កាត ២</option>
                        <option value="p2_card3">កាត ៣</option>
                        <option value="p2_card4">កាត ៤</option>
                    </select>
                    <select class="pspt_Page2_background-dropdown" id="p2_rotationDropdown" onchange="pspt_Page2_rotateBackground()">
        ...
        <div class="pspt_Page2_displayArea">
            <div id="p2_cardsContainer" class="pspt_Page2_grid">
                ...
                <div class="pspt_Page2_card" id="p2_card1">
                    <div class="pspt_Page2_card-content">
                        <img class="pspt_Page2_card-bg" src="/docs/images/1.png" alt="Card background 1">
                    </div>
                </div>
                <!-- Card 2 -->
                <div class="pspt_Page2_card" id="p2_card2">
                    <div class="pspt_Page2_card-content">
                        <img class="pspt_Page2_card-bg" src="/docs/images/2.png" alt="Card background 2">
                    </div>
                </div>
                <!-- Card 3 -->
                <div class="pspt_Page2_card" id="p2_card3">
                    <div class="pspt_Page2_card-content" style="padding: 5px;">
                        <img class="pspt_Page2_card-bg" src="/docs/images/4.png" alt="Card background 3">
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function pspt_Page2_updateCurrentCard() {
                ...
                const bgImg = card2.querySelector('.pspt_Page2_card-bg');

                if (bgImg) {
                    if (backgroundUrl) {
                        bgImg.src = backgroundUrl;
                        bgImg.style.display = '';
                        card2.querySelector('.pspt_Page2_card-content').style.backgroundColor = '';
                    } else {
                        bgImg.style.display = 'none';
                        card2.querySelector('.pspt_Page2_card-content').style.backgroundColor = 'white';
                    }
                }
            }
            ...
            function pspt_Page2_changeBackgroundFromDropdown() {
                ...
                if (dropdown.value) {
                    const selectedCard = document.getElementById(dropdown.value);
                    if (selectedCard) {
            ...
            function pspt_Page2_rotateBackground() {
                const dropdown = document.getElementById('p2_rotationDropdown');
                const rotation = dropdown.value;
                const bgImg = currentCard.querySelector('.pspt_Page2_card-content .pspt_Page2_card-bg');
                if (bgImg) {
            ...
            window.pspt_Page2_rotateBackground = pspt_Page2_rotateBackground;
            ...
            function pspt_Page2_changeBackground() {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        // Ensure currentCard is aligned with selected dropdown card if any
                        const dropdown = document.getElementById('p2_backgroundDropdown');
                        ...
                        let bgImg = currentCard.querySelector('.pspt_Page2_card-bg');
                        if (!bgImg) {
                            const cardContent = currentCard.querySelector('.pspt_Page2_card-content');
                            if (cardContent) {
                                bgImg = document.createElement('img');
                                bgImg.classList.add('pspt_Page2_card-bg');
                                cardContent.insertBefore(bgImg, cardContent.firstChild);
                            }
                        }
                        if (bgImg) {
            ...
            function pspt_Page2_resetBackground() {
                ...
                const bgImg = currentCard.querySelector('.pspt_Page2_card-bg');
                if (cardId === 'p2_card4') {
                    if (bgImg) bgImg.remove();
                    cardContent.style.backgroundColor = defaultBackgrounds[cardId];
                } else {
                    if (bgImg) {
                        bgImg.src = defaultBackgrounds[cardId];
                ...
                document.getElementById('p2_rotationDropdown').value = '0';
            }
            ...
            async function pspt_Page2_downloadCards() {
                ...
                const allCards = document.querySelectorAll('.pspt_Page2_card');
                ...
                try {
                    ...
                    // Compute dimensions keeping aspect ratio
