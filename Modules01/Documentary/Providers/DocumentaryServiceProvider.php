...
namespace Modules\Documentary\Providers;
...
class DocumentaryServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'Documentary';
    protected string $moduleNameLower = 'documentary';

    protected $middleware = [
        'Documentary' => [
            'DocumentaryLanguage' => 'ModuleLanguageMiddleware',
        ],
    ];
