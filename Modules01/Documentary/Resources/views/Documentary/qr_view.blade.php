<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('documentary::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            $fileExtension = strtolower(pathinfo($documentary->category->image, PATHINFO_EXTENSION));
            @endphp

            @if(in_array($fileExtension, $imageExtensions))
            <div class="profile-image">
                <img src="{{ asset('uploads/DocumentaryCategory/' . basename($documentary->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/DocumentaryCategory/' . basename($documentary->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $documentary->category->name }}</h3>
                <p>{!! $documentary->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="title_1content">
    <h4>@lang('documentary::lang.title_1')</h4>
    <p>{{ $documentary->title_1 }}</p>
</div>
<div class="profile-section" id="url_5content">
    <h4>@lang('documentary::lang.url_5')</h4>
    <p>{{ $documentary->url_5 }}</p>
</div>
<div class="profile-section" id="file_6content">
    <h4>@lang('documentary::lang.file_6')</h4>
    <div class="profile-image">
        <img src="{{ asset('uploads/Documentary/' . $documentary->file_6) }}" alt="Document Image">
    </div>
</div>
        <!-- Additional Sections -->
        ...
        <div class="profile-section" id="createdatcontent">
            ...
            <p>{{ $documentary->created_at }}</p>
        </div>

        <!-- QR Code Section -->
        <div class="profile-section" id="qrcontent">
            <h4>@lang('documentary::lang.qrcode')</h4>
