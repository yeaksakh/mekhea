...
|
*/
Route::get('/product/{business_id}/{id}/{group_price_id?}', [\Modules\ProductCatalogue\Http\Controllers\ProductCatalogueController::class, 'showProduct']);
Route::get('/business/{business_id}/customer/{id}', 
    [\Modules\ProductCatalogue\Http\Controllers\ProductCatalogueController::class, 'showCustomer'])
    ->name('public.customer.show');
Route::get('/employee/{id}', [\Modules\ProductCatalogue\Http\Controllers\ProductCatalogueController::class, 'showEmployee']);
...
Route::middleware('web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu')->prefix('product-catalogue')->group(function () {
    ...
    Route::get('export-customer-qr-excel', [\Modules\ProductCatalogue\Http\Controllers\ProductCatalogueController::class, 'exportCustomerQrExcel'])->name('export_customer_qr_excel');
