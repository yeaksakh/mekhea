<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('schedulepayment::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/SchedulePaymentCategory/' . basename($schedulepayment->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/SchedulePaymentCategory/' . basename($schedulepayment->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $schedulepayment->category->name }}</h3>
                <p>{!! $schedulepayment->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="title_1content">
    <h4>@lang('schedulepayment::lang.title_1')</h4>
    <p>{{ $schedulepayment->title_1 }}</p>
</div>
<div class="profile-section" id="date_paid_5content">
    <h4>@lang('schedulepayment::lang.date_paid_5')</h4>
    <p>{{ $schedulepayment->date_paid_5 }}</p>
</div>
<div class="profile-section" id="date_prepare_pay_6content">
    <h4>@lang('schedulepayment::lang.date_prepare_pay_6')</h4>
    <p>{{ $schedulepayment->date_prepare_pay_6 }}</p>
</div>
<div class="profile-section" id="status_7content">
    <h4>@lang('schedulepayment::lang.status_7')</h4>
    <p>{{ $schedulepayment->status_7 }}</p>
</div>
<div class="profile-section" id="note_8content">
    <h4>@lang('schedulepayment::lang.note_8')</h4>
    <p>{{ $schedulepayment->note_8 }}</p>
</div>
        <!-- Additional Sections -->
        ...
        <div class="profile-section" id="createdatcontent">
            ...
            <p>{{ $schedulepayment->created_at }}</p>
        </div>

        <!-- QR Code Section -->
        <div class="profile-section" id="qrcontent">
            <h4>@lang('schedulepayment::lang.qrcode')</h4>
