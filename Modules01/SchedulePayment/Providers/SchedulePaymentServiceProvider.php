...
namespace Modules\SchedulePayment\Providers;
...
class SchedulePaymentServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'SchedulePayment';
    protected string $moduleNameLower = 'schedulepayment';

    protected $middleware = [
        'SchedulePayment' => [
            'SchedulePaymentLanguage' => 'ModuleLanguageMiddleware',
        ],
    ];
