...
namespace Modules\CustomerCardB1\Providers;
...
class CustomerCardB1ServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'CustomerCardB1';
    protected string $moduleNameLower = 'customercardb1';

    protected $middleware = [
        'CustomerCardB1' => [
            'CustomerCardB1Language' => 'ModuleLanguageMiddleware',
        ],
    ];
