<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('customercardb1::lang.add_category')</h4>
        </div>
        <div class="modal-body">
            <form id="category_add_form" method="POST" action="{{ route('CustomerCardB1-categories.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                        <label for="name">@lang('customercardb1::lang.name'):</label>                     
                    ...
                    <div class="col-md-12">
                    <div class="form-group">                     
                        <label for="description">@lang('customercardb1::lang.description'):</label>                     
