@extends('layouts.app')
@section('title', __('customercardb1::visa.edit_indicator'))
@section('content')
...
<section class="content-header">
    <h1>@lang('customercardb1::visa.edit_indicator')</h1>
</section>

<!-- Main Content -->
<section class="content">
    {!! Form::model($indicator, ['route' => ['customercardb1.visa.indicator.update', $indicator->id], 'method' => 'put']) !!}
    {{ csrf_field() }}
