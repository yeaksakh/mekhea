<div class="modal-dialog modal-lg" id="yourModalId" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h4 class="modal-title text-center" style="color: #024cd7;">@lang('customercardb1::visa.view_appraisal')</h4>
...
<script>
    function printDiv(divName) {
        ...
        window.location.href = '/customercardb1/appraisal-list'; // Update this URL based on your routing
    }
</script>
