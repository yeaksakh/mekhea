...
@section('content')
    ...
    <section class="content">
        ...
        <!-- Navbar -->
        @includeIf('customercardb1::layouts.navbar')
        {{-- @includeIf('customercardb1::layouts.navbarwidget') --}}
                ...
                <div class="nav-tabs-custom">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="welcome_card_tab">
                            <div class="row">
                                <div class="col-md-12" align="center">
                                    @include('customercardb1::customer.partials.card.welcome_card')
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="letter_allow_production_tab">
                            <div class="row">
                                <div class="col-md-12">
                                    @include('customercardb1::customer.partials.letter_allow_production')
                                </div>
                            </div>
                        </div>
                    </div>
