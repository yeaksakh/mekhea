        ...
        <div class="modal-body">
            ...
            @component('components.widget')
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('contact_id', null, ['class' => 'form-control','placeholder' => __('lang_v1.leave_empty_to_autogenerate')]); !!}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-addon" style="background-color: green;">
                                <a href="{{ url(action([\App\Http\Controllers\CustomerGroupController::class, 'index'])) }}"
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('register_date', null, ['class' => 'form-control dob-date-picker','required' => 'required','placeholder' => __('lang_v1.register_date'), 'readonly']); !!}
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 ">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('expired_date', null, ['class' => 'form-control expired-date-picker','placeholder' => __('lang_v1.expired_date'), 'readonly']); !!}
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 ">
                    <div class="form-group">
                        {!! Form::label('study_date', __('lang_v1.study_date') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>

                            {!! Form::text('study_date', null, ['class' => 'form-control expired-date-picker','placeholder' => __('lang_v1.study_date'), 'readonly']); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    {!! Form::date('id_proof_number', null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.id_proof_number' ) ]); !!}
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('assigned_to_users[]', $users ?? [], null , ['class' => 'form-control select2', 'id' => 'assigned_to_users', 'multiple','required', 'style' => 'width: 100%;']); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('country', null, ['class' => 'form-control', 'required', 'placeholder' => __('business.country')]); !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
