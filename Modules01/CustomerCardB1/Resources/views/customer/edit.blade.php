        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    {!! Form::select('gender', ['male' => __('lang_v1.male'), 'female' => __('lang_v1.female'), 'others' => __('lang_v1.others')], !empty($contact->gender) ? $contact->gender : null, ['class' => 'form-control', 'id' => 'gender', 'placeholder' => __( 'messages.please_select') ]); !!}
                </div>
                ...
                <div class="customer_fields"></div>
                <div class="col-md-6" @if($contact->contact_type == '' || empty($contact->contact_type)) @endif>
                    <div class="form-group">
                ...
                <div class="col-md-3" @if($contact->contact_type == '' || empty($contact->contact_type)) @endif>
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group" @if($contact->contact_type == '') @endif>
                ...
                <div class="col-sm-4">
                    <div class="form-group individual" @if($contact->contact_type == 'business') style="display: none;" @endif>
                        {!! Form::label('register_date', __('lang_v1.register_date') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>

                            {!! Form::text('register_date', !empty($contact->register_date) ? @format_date($contact->register_date) : null, ['class' => 'form-control dob-date-picker','placeholder' => __('lang_v1.register_date'), 'readonly']); !!}
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group individual" @if($contact->contact_type == 'business') style="display: none;" @endif>
                        {!! Form::label('expired_date', __('lang_v1.expired_date') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>

                            {!! Form::text('expired_date', !empty($contact->expired_date) ? @format_date($contact->expired_date) : null, ['class' => 'form-control expired-date-picker','placeholder' => __('lang_v1.expired_date'), 'readonly']); !!}
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 ">
                    <div class="form-group">
                        {!! Form::label('study_date', __('contact.study_date') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>

                            {!! Form::text('study_date', !empty($contact->study_date) ? @format_date($contact->study_date) : null, ['class' => 'form-control expired-date-picker','placeholder' => __('lang_v1.study_date'), 'readonly']); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    {!! Form::text('id_proof_name', !empty($contact->id_proof_name) ? $contact->id_proof_name : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.id_proof_name' ) ]); !!}
                </div>
                <div class="form-group col-md-3">
                    {!! Form::label('id_proof_number', __( 'lang_v1.id_proof_number') . ':') !!}
                    {!! Form::text('id_proof_number', !empty($contact->id_proof_number) ? $contact->id_proof_number: null, ['class' => 'form-control expired-date-picker', 'placeholder' => __( 'lang_v1.id_proof_number' ) ]); !!}
                </div>
