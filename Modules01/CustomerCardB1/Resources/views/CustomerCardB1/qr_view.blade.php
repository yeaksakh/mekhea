<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('customercardb1::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/CustomerCardB1Category/' . basename($customercardb1->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/CustomerCardB1Category/' . basename($customercardb1->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $customercardb1->category->name }}</h3>
                <p>{!! $customercardb1->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="customer_1content">
    <h4>@lang('customercardb1::lang.customer_1')</h4>
    <p>{{ $customercardb1->customer1->name }}</p>
</div>
        <!-- Additional Sections -->
        ...
        <div class="profile-section" id="createdatcontent">
            ...
            <p>{{ $customercardb1->created_at }}</p>
        </div>

        <!-- QR Code Section -->
        <div class="profile-section" id="qrcontent">
            <h4>@lang('customercardb1::lang.qrcode')</h4>
