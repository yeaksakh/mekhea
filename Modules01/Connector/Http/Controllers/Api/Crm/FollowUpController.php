   ...
   public function index()
{
    ...
    $has_permission = false; // Add your permission checking logic here
    ...
    if ($per_page != -1) {
        $follow_ups = $query->paginate($per_page)->through(function ($schedule) {
            if ($schedule->users->first()) {
                $schedule->user_first_name = $schedule->users->first()->first_name;
                $schedule->user_last_name = $schedule->users->first()->last_name;
            } else {
        ...
        $follow_ups = $query->get()->map(function ($schedule) {
            if ($schedule->users->first()) {
                $schedule->user_first_name = $schedule->users->first()->first_name;
                $schedule->user_last_name = $schedule->users->first()->last_name;
            } else {
