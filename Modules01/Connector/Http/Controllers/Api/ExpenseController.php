...
class ExpenseController extends ApiController
{
    ...
    public function index()
    {
        ...
        $query = Transaction::withoutGlobalScope('Illuminate\Database\Eloquent\SoftDeletingScope')->from('transactions as t')
    ...
    public function show($expense_ids)
    {
        ...
        $expenses = Transaction::from('transactions as t')
            ->with(['payment_lines', 'transaction_for']) // Eager-load payment_lines and transaction_for
            ->where('t.business_id', $business_id)
            ->withoutGlobalScopes()
            ->leftJoin('business_locations as bl', 't.location_id', '=', 'bl.id')
            ->leftJoin('expense_categories as ec', 'ec.id', '=', 't.expense_category_id')
    ...
    public function destroy($id)
    {
        try {
            ...
            // Delete associated cash register payments
