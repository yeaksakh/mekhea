...
namespace Modules\DocumentKeeper\Providers;
...
class DocumentKeeperServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'DocumentKeeper';
    protected string $moduleNameLower = 'documentkeeper';

    protected $middleware = [
        'DocumentKeeper' => [
            'DocumentKeeperLanguage' => 'ModuleLanguageMiddleware',
        ],
    ];
