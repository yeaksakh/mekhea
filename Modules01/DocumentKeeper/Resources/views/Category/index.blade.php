...
@section('content')
    ...
    <section class="content-header no-print">
        <h1>
            @lang('documentkeeper::lang.category')
        </h1>
    </section>
    <!-- Main content -->
    <section class="content no-print">
        <div class="box box-solid">
            <div class="box-header with-border">
                <h5 class="box-title">
                    @lang('documentkeeper::lang.all_category')
                </h5>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-sm btn-primary btn-modal" data-href="{{ route('DocumentKeeper-categories.create') }}" data-container=".category_modal">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="categories_table">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>@lang('documentkeeper::lang.name')</th>
                                <th>@lang('documentkeeper::lang.image')</th>
                                <th>@lang('documentkeeper::lang.description')</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#categories_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ action([\Modules\DocumentKeeper\Http\Controllers\DocumentKeeperController::class, 'getCategories']) }}",
                },
                order: [[1, 'desc']],
                columns: [
                    {
