<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        {!! Form::open(['url' => action([\Modules\DocumentKeeper\Http\Controllers\DocumentKeeperController::class, 'store']), 'method' => 'post', 'id' => 'add_DocumentKeeper_form' ]) !!}
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">@lang('documentkeeper::lang.add_DocumentKeeper')</h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="documentkeeper_category_id" name="documentkeeper_category_id" style="width: 100%;">
