<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('sop::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/SOPCategory/' . basename($sop->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/SOPCategory/' . basename($sop->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $sop->category->name }}</h3>
                <p>{!! $sop->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="title_1content">
    <h4>@lang('sop::lang.title_1')</h4>
    <p>{{ $sop->title_1 }}</p>
</div>
<div class="profile-section" id="description_5content">
    <h4>@lang('sop::lang.description_5')</h4>
    <p>{{ $sop->description_5 }}</p>
</div>
        <!-- Additional Sections -->
