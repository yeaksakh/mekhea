    ...
    <section class="content no-print">
        <div class="box box-solid">
            <div class="box-header with-border">
                <h5 class="box-title">
                    @lang('sop::lang.all_category')
                </h5>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-sm btn-primary btn-modal" data-href="{{ route('SOP-categories.create') }}" data-container=".category_modal">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="categories_table">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>@lang('sop::lang.name')</th>
                                <th>@lang('sop::lang.image')</th>
                                <th>@lang('sop::lang.description')</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#categories_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ action([\Modules\SOP\Http\Controllers\SOPController::class, 'getCategories']) }}",
                },
                order: [[1, 'desc']],
                columns: [
                    {
