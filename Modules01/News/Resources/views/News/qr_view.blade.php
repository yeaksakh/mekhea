<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('news::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/NewsCategory/' . basename($news->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/NewsCategory/' . basename($news->category->image)) }}" target="_blank">
    ...
    <h4>@lang('news::lang.title_1')</h4>
    <p>{{ $news->title_1 }}</p>
</div>
<div class="profile-section" id="image_5content">
    <h4>@lang('news::lang.image_5')</h4>
    <div class="profile-image">
        <img src="{{ asset('uploads/News/' . $news->image_5) }}" alt="Document Image">
    </div>
</div>
<div class="profile-section" id="description_6content">
    <h4>@lang('news::lang.description_6')</h4>
    <p>{{ $news->description_6 }}</p>
</div>
<div class="profile-section" id="image_2_7content">
    <h4>@lang('news::lang.image_2_7')</h4>
    <div class="profile-image">
        <img src="{{ asset('uploads/News/' . $news->image_2_7) }}" alt="Document Image">
    </div>
</div>
        <!-- Additional Sections -->
