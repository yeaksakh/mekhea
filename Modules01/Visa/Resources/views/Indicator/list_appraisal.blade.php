...
<section class="content no-print">
    ...
    @slot('tool')
    <div class="box-tools">
        <a class="btn btn-block btn-primary" href="{{ action([Modules\Visa\Http\Controllers\IndicatorController::class, 'appraisal']) }}">
    ...
    <table class="table table-bordered table-striped" id="appraisal_table" style="width: 100%;">
        <thead>
            <tr>
                ...
                <!-- <th>@lang('visa::lang.department')</th> -->
                <th>@lang('visa::lang.month')</th>
                <th>@lang('visa::lang.actual_value')</th>
                <!-- <th>@lang('visa::lang.actual_score')</th> -->
