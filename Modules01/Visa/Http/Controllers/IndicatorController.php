...
use Modules\Visa\Entities\VisaAppraisal;
use Modules\Visa\Entities\VisaIndicator;
use Modules\Visa\Entities\VisaCompetency;
use Modules\Visa\Entities\VisaAppraisalScore;
    ...
    public function appraisal_view(Request $request, $id)
{
    ...
    $appraisalData = VisaAppraisal::from('visa_appraisals as a')
        ...
        return view('visa::Indicator.view_appraisal', compact('appraisalData'));
}
