    ...
    <div class="row">
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                ...
                <div class="row">
                    <div class="col-md-12">
                    @component('components.filters', ['title' => __('report.filters'), 'class' => 'box-solid', 'closed' => true, 'id' => 'filters1'])
                            @can('essentials.view_all_payroll')
                                <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('date_range', null, ['placeholder' => __('lang_v1.select_a_date_range'), 'class' => 'form-control', 'id' => 'contact_date_range', 'readonly']); !!}
                                </div>
                            </div>
                            @endif
                        @endcomponent
        ...
        $(document).ready( function(){
            ...
            @if(auth()->user()->can('essentials.view_allowance_and_deduction') || auth()->user()->can('essentials.add_allowance_and_deduction'))
                ...
                ad_pc_table = $('#ad_pc_table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ action([\Modules\Essentials\Http\Controllers\EssentialsAllowanceAndDeductionController::class, 'index']) }}",
                        data: function(d) {
                            // Date Range Filter
                            if ($('#contact_date_range').val()) {
            ...
            //payroll groups
             @can('essentials.view_all_payroll')
                payroll_group_table = $('#payroll_group_table').DataTable({
                        ...
                        serverSide: true,
                        ajax: {
                            url:"{{action([\Modules\Essentials\Http\Controllers\PayrollController::class, 'payrollGroupDatatable'])}}",
                            data: function(d) {
                            // Date Range Filter
                            if ($('#contact_date_range').val()) {
                                d.start_date = $('#contact_date_range')
                    ...
                    $(document).on('change', '#user_id_filter,#contact_date_range, #location_id_filter, #department_id, #designation_id, #month_year_filter', function() {
