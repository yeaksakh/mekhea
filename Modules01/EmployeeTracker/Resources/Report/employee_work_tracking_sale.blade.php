@extends('layouts.app')
@section('title', __('employeetracker::lang.employee_tracker_sale'))
...
@section('content')
    ...
    <div style="margin: 16px" class="no-print">
        @component('components.filters', ['title' => 'Sales Work Tracking'])
            <div class="col-md-3">
            ...
            @include('employeetracker::components.printbutton', [
                'report_name' => __('employeetracker::lang.employee_tracker_sale'),
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var employee_work_table = $('#employee_work_table').DataTable({
                ...
                serverSide: false,
                ajax: {
                    url: "{{ action([\Modules\EmployeeTracker\Http\Controllers\EmployeeReportController::class, 'getSalesEmployeeWorkTrackingReport']) }}",
                    data: function(d) {
