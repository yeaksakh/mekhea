...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'employeetracker';
        $this->appVersion = config('employeetracker.module_version');
        $this->module_display_name = 'EmployeeTracker';
    }
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => 'EmployeeTracker', '--force' => true]);
            System::addProperty($this->module_name . '_version', $this->appVersion);
        }

        $action_url = action([\Modules\EmployeeTracker\Http\Controllers\InstallController::class, 'install']);
        $intruction_type = 'uf';
        $action_type = 'install';
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = [
                'success' => 1,
                'msg' => 'EmployeeTracker module updated successfully to version ' . $this->appVersion . ' !!',
            ];
    ...
    public function install()
    {
        try {
            ...
            Artisan::call('migrate', [
                '--path' => 'Modules/EmployeeTracker/Database/Migrations',
                '--force' => true
            ]);
            ...
            Artisan::call('module:publish', ['module' => 'EmployeeTracker']);

            // Optimize the application clearing cache
            Artisan::call('optimize:clear');

            $output = ['success' => 1, 'msg' => 'EmployeeTracker module installed successfully'];
        } catch (\Exception $e) {
