            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('description', $project_task->description, ['class' => 'form-control summernote']) !!}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text(
                            'start_date',
                            !empty($project_task->start_date) ? @format_datetime($project_task->start_date) : '',
                            [
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('due_date', !empty($project_task->due_date) ? @format_datetime($project_task->due_date) : '', [
                            'class' => 'form-control datetimepicker',
                            'readonly',
                        ]) !!}
                    </div>
