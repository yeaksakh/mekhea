<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('bottelegrammanager::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/BotTelegramManagerCategory/' . basename($bottelegrammanager->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/BotTelegramManagerCategory/' . basename($bottelegrammanager->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $bottelegrammanager->category->name }}</h3>
                <p>{!! $bottelegrammanager->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="id_1content">
    <h4>@lang('bottelegrammanager::lang.id_1')</h4>
    <div class="profile-image">
        <img src="{{ asset('uploads/BotTelegramManager/' . $bottelegrammanager->id_1) }}" alt="Document Image">
    </div>
</div>
        <!-- Additional Sections -->
        ...
        <div class="profile-section" id="createdatcontent">
            ...
            <p>{{ $bottelegrammanager->created_at }}</p>
        </div>

        <!-- QR Code Section -->
        <div class="profile-section" id="qrcontent">
            <h4>@lang('bottelegrammanager::lang.qrcode')</h4>
