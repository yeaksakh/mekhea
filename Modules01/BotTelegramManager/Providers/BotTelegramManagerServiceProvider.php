...
namespace Modules\BotTelegramManager\Providers;
...
class BotTelegramManagerServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'BotTelegramManager';
    protected string $moduleNameLower = 'bottelegrammanager';

    protected $middleware = [
        'BotTelegramManager' => [
            'BotTelegramManagerLanguage' => 'ModuleLanguageMiddleware',
        ],
    ];
