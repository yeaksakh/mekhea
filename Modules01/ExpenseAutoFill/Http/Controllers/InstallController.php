...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'expenseautofill';
        $this->appVersion = config('expenseautofill.module_version');
        $this->module_display_name = 'ExpenseAutoFill';
    }
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => 'ExpenseAutoFill', '--force' => true]);
            System::addProperty($this->module_name . '_version', $this->appVersion);
        }

        $action_url = action([\Modules\ExpenseAutoFill\Http\Controllers\InstallController::class, 'install']);
        $intruction_type = 'uf';
        $action_type = 'install';
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = [
                'success' => 1,
                'msg' => 'ExpenseAutoFill module updated successfully to version ' . $this->appVersion . ' !!',
            ];
    ...
    public function install()
    {
        try {
            ...
            Artisan::call('migrate', [
                '--path' => 'Modules/ExpenseAutoFill/Database/Migrations',
                '--force' => true
            ]);

            // Publish module assets or configurations
            Artisan::call('module:publish', ['module' => 'ExpenseAutoFill']);

            // Optimize the application clearing cache
            Artisan::call('optimize:clear');

            $output = ['success' => 1, 'msg' => 'ExpenseAutoFill module installed successfully'];
        } catch (\Exception $e) {
