<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('expenseautofill::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/ExpenseAutoFillCategory/' . basename($expenseautofill->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/ExpenseAutoFillCategory/' . basename($expenseautofill->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $expenseautofill->category->name }}</h3>
                <p>{!! $expenseautofill->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="title_1content">
    <h4>@lang('expenseautofill::lang.title_1')</h4>
    <p>{{ $expenseautofill->title_1 }}</p>
</div>
<div class="profile-section" id="topic _5content">
    <h4>@lang('expenseautofill::lang.topic _5')</h4>
    <p>{{ $expenseautofill->topic _5 }}</p>
</div>
        <!-- Additional Sections -->
        ...
        <div class="profile-section" id="createdatcontent">
            ...
            <p>{{ $expenseautofill->created_at }}</p>
        </div>

        <!-- QR Code Section -->
        <div class="profile-section" id="qrcontent">
            <h4>@lang('expenseautofill::lang.qrcode')</h4>
