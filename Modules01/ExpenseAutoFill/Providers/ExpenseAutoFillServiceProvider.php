...
namespace Modules\ExpenseAutoFill\Providers;
...
class ExpenseAutoFillServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'ExpenseAutoFill';
    protected string $moduleNameLower = 'expenseautofill';

    protected $middleware = [
        'ExpenseAutoFill' => [
            'ExpenseAutoFillLanguage' => 'ModuleLanguageMiddleware',
        ],
    ];
