<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('expenserequest::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/ExpenseRequestCategory/' . basename($expenserequest->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/ExpenseRequestCategory/' . basename($expenserequest->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $expenserequest->category->name }}</h3>
                <p>{!! $expenserequest->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="amount_1content">
    <h4>@lang('expenserequest::lang.amount_1')</h4>
    <p>{{ $expenserequest->amount_1 }}</p>
</div>
<div class="profile-section" id="expense_for_2content">
    <h4>@lang('expenserequest::lang.expense_for_2')</h4>
    <p>{{ $expenserequest->expense_for_2 }}</p>
</div>
<div class="profile-section" id="who_request_expense_3content">
    <h4>@lang('expenserequest::lang.who_request_expense_3')</h4>
    <p>{{ $expenserequest->whorequestexpense3->first_name . ' ' . $expenserequest->whorequestexpense3->last_name }}</p>
</div>
        <!-- Additional Sections -->
        ...
        <div class="profile-section" id="createdatcontent">
            ...
            <p>{{ $expenserequest->created_at }}</p>
        </div>

        <!-- QR Code Section -->
        <div class="profile-section" id="qrcontent">
            <h4>@lang('expenserequest::lang.qrcode')</h4>
