...
<div class="modal-content">
    ...
    <div class="modal-body">
        {!! Form::model($category, ['url' => action([\Modules\ExpenseRequest\Http\Controllers\ExpenseRequestController::class, 'updateCategory'], $category->id), 'method' => 'put', 'id' => 'category_edit_form' ]) !!}
        <div class="form-group">
            {!! Form::label('name', __('expenserequest::lang.name') . ':*') !!}
            {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => __('expenserequest::lang.category_name')]) !!}
        </div>
        <div class="form-group">
            {!! Form::label('image', __('expenserequest::lang.image') . ':') !!}
            {!! Form::file('image', [
                'id' => 'image',
            ...
            @if($category->{'image'})
                @php
                    ...
                    $filePath = 'uploads/ExpenseRequestCategory/' . basename($category->{'image'});
                @endphp
        ...
        <div class="form-group">
            {!! Form::label('description', __('expenserequest::lang.description') . ':') !!}
            {!! Form::textarea('description', null, ['class' => 'form-control','id'=>'summernote', 'placeholder' => __('expenserequest::lang.description'), 'rows' => 3]) !!}
        </div>
