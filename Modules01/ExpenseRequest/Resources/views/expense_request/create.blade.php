@extends('layouts.app')
@section('title', __('expense.add_expense_request'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('expense.add_expense_request')</h1>
</section>
...
<section class="content">
	...
	<div class="box box-solid">
		<div class="box-body">
			<div class="row">
			<input type="hidden" name="expense_request" value="expense_request">
          ...
          <div class="form-group">
				...
				<div class="col-sm-4">
          <div class="form-group">
						{!! Form::label('expense_for', __('expense.request_by').':') !!} 
				 ...
				 <div class="col-sm-4">
					<div class="form-group">
						{!! Form::label('final_total', __('expense.request_amount') . ':*') !!}
				...
				<div class="col-sm-4">
					<div class="form-group">
						{!! Form::label('transaction_date', __('expense.request_date') . ':*') !!}
