...
namespace Modules\PurchaseAutoFill\Providers;
...
class PurchaseAutoFillServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'PurchaseAutoFill';
    protected string $moduleNameLower = 'purchaseautofill';

    protected $middleware = [
        'PurchaseAutoFill' => [
            'PurchaseAutoFillLanguage' => 'ModuleLanguageMiddleware',
        ],
    ];
