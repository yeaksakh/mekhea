...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'purchaseautofill';
        $this->appVersion = config('purchaseautofill.module_version');
        $this->module_display_name = 'PurchaseAutoFill';
    }
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => 'PurchaseAutoFill', '--force' => true]);
            System::addProperty($this->module_name . '_version', $this->appVersion);
        }

        $action_url = action([\Modules\PurchaseAutoFill\Http\Controllers\InstallController::class, 'install']);
        $intruction_type = 'uf';
        $action_type = 'install';
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = [
                'success' => 1,
                'msg' => 'PurchaseAutoFill module updated successfully to version ' . $this->appVersion . ' !!',
            ];
    ...
    public function install()
    {
        try {
            ...
            Artisan::call('migrate', [
                '--path' => 'Modules/PurchaseAutoFill/Database/Migrations',
                '--force' => true
            ]);

            // Publish module assets or configurations
            Artisan::call('module:publish', ['module' => 'PurchaseAutoFill']);

            // Optimize the application clearing cache
            Artisan::call('optimize:clear');

            $output = ['success' => 1, 'msg' => 'PurchaseAutoFill module installed successfully'];
        } catch (\Exception $e) {
