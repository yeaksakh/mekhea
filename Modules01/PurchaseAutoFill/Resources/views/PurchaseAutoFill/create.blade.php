<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        {!! Form::open(['url' => action([\Modules\PurchaseAutoFill\Http\Controllers\PurchaseAutoFillController::class, 'store']), 'method' => 'post', 'id' => 'add_PurchaseAutoFill_form' ]) !!}
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">@lang('purchaseautofill::lang.add_PurchaseAutoFill')</h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="purchaseautofill_category_id" name="purchaseautofill_category_id" style="width: 100%;">
