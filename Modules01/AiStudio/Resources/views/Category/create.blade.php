<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('aistudio::lang.add_category')</h4>
        </div>
        <div class="modal-body">
            <form id="category_add_form" method="POST" action="{{ route('AiStudio-categories.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                        <label for="name">@lang('aistudio::lang.name'):</label>                     
                    ...
                    <div class="col-md-12">
                    <div class="form-group">                     
                        <label for="description">@lang('aistudio::lang.description'):</label>                     
