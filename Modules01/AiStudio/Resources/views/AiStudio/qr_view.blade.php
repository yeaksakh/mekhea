<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('aistudio::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/AiStudioCategory/' . basename($aistudio->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/AiStudioCategory/' . basename($aistudio->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $aistudio->category->name }}</h3>
                <p>{!! $aistudio->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="message_1content">
    <h4>@lang('aistudio::lang.message_1')</h4>
    <p>{{ $aistudio->message_1 }}</p>
</div>
        <!-- Additional Sections -->
        ...
        <div class="profile-section" id="createdatcontent">
            ...
            <p>{{ $aistudio->created_at }}</p>
        </div>

        <!-- QR Code Section -->
        <div class="profile-section" id="qrcontent">
            <h4>@lang('aistudio::lang.qrcode')</h4>
