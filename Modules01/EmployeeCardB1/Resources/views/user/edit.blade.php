  ...
  {!! Form::open(['url' => action([\App\Http\Controllers\ManageUserController::class, 'update'], [$user->id]), 'method' => 'PUT', 'id' => 'user_edit_form', 'files' => true]) !!}
    <div class="row">
      ...
      <div class="col-md-6">
        <div id="profile_photo_container">
          @if(!empty($user->media))
          <div class="col-md-12 text-center" id="profile_photo_existing">
            <br>
            {!! $user->media->thumbnail([150, 150], 'img-square') !!}
          </div>
          @endif
      ...
      <script>
        function previewImage(input, previewId, existingId = null) {
          const file = input.files[0];
          const preview = document.getElementById(previewId);
          const existingImg = existingId ? document.getElementById(existingId) : null;
          ...
          if (file) {
            ...
            reader.onload = function(e) {
              ...
              if (existingImg) {
                existingImg.style.display = 'none'; // Hide existing image/thumbnail
              }
            }
            ...
            if (existingImg) {
              existingImg.style.display = existingImg.innerHTML ? 'block' : 'none'; // Show existing if it exists
            }
          }
        }
        ...
        document.getElementById('profile_photo').addEventListener('change', function() {
          previewImage(this, 'profile_photo_preview', 'profile_photo_existing');
        });

        document.getElementById('sign_image').addEventListener('change', function() {
          previewImage(this, 'sign_image_preview', 'sign_image_existing');
        });
      </script>
      @endcomponent
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            {!! Form::text('name_in_khmer', $user->name_in_khmer, ['class' => 'form-control', 'placeholder' => __( 'Name In Khmer' ) ]); !!}
        </div>
    </div>
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            {!! Form::text('uniform_size', $user->uniform_size, ['class' => 'form-control', 'placeholder' => __( 'Uniform Size' ) ]); !!}
        </div>
    </div>
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            {!! Form::date('member_date', $user->member_date, ['class' => 'form-control']); !!}
        </div>
    </div>
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            {!! Form::number('hieght', $user->hieght, ['class' => 'form-control', 'placeholder' => __( 'Hieght' ), 'step' => '0.01']); !!}
        </div>
    </div>
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            {!! Form::number('weight', $user->weight, ['class' => 'form-control', 'placeholder' => __( 'Weight' ), 'step' => '0.01']); !!}
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::text('hobby', $user->hobby, ['class' => 'form-control', 'placeholder' => __( 'Hobby' ) ]); !!}
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::text('education', $user->education, ['class' => 'form-control', 'placeholder' => __( 'Education' ) ]); !!}
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::select('guardien_type', [
                ...
                'sibling' => __('Sibling'),
                'other' => __('Other')
            ], $user->guardien_type, ['class' => 'form-control', 'placeholder' => __( 'Select Guardien Type' )]); !!}
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::text('insurance_number', $user->insurance_number, ['class' => 'form-control', 'placeholder' => __( 'Insurance Number' ) ]); !!}
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::text('ss_number', $user->ss_number, ['class' => 'form-control', 'placeholder' => __( 'SS Number' ) ]); !!}
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::date('date_left_job', $user->date_left_job, ['class' => 'form-control']); !!}
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::text('reason', $user->reason, ['class' => 'form-control', 'placeholder' => __( 'Reason' ) ]); !!}
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!! Form::textarea('job_history', $user->job_history, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __( 'Detailed job history' ) ]); !!}
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!! Form::textarea('job_description', $user->job_description, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __( 'Detailed job description' ) ]); !!}
        </div>
    </div>
@endcomponent
       @component('components.widget', ['title' => __('role.access_locations')]) 
        <div class="clearfix"></div>
            <div class="col-md-3">
      ...
      @component('components.widget')
    @slot('title')
        {{ __('lang_v1.selected_contacts') }} @show_tooltip(__('lang_v1.commsn_percent_help'))
    @endslot
    ...
    <div class="col-sm-4 selected_contacts_div @if(!$user->selected_contacts) hide @endif">
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                ['class' => 'form-control select2', 'multiple', 'style' => 'width: 100%;', 'id' => 'user_allowed_contacts']) !!}
            </div>
        </div>
    </div>
@endcomponent
