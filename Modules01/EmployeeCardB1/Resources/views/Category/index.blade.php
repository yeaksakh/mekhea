...
@section('content')
    ...
    <section class="content-header no-print">
        <h1>
            @lang('employeecardb1::lang.category')
        </h1>
    </section>
    <!-- Main content -->
    <section class="content no-print">
        <div class="box box-solid">
            <div class="box-header with-border">
                <h5 class="box-title">
                    @lang('employeecardb1::lang.all_category')
                </h5>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-sm btn-primary btn-modal" data-href="{{ route('EmployeeCardB1-categories.create') }}" data-container=".category_modal">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="categories_table">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>@lang('employeecardb1::lang.name')</th>
                                <th>@lang('employeecardb1::lang.image')</th>
                                <th>@lang('employeecardb1::lang.description')</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#categories_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ action([\Modules\EmployeeCardB1\Http\Controllers\EmployeeCardB1Controller::class, 'getCategories']) }}",
                },
                order: [[1, 'desc']],
                columns: [
                    {
