<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('employeecardb1::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/EmployeeCardB1Category/' . basename($employeecardb1->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/EmployeeCardB1Category/' . basename($employeecardb1->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $employeecardb1->category->name }}</h3>
                <p>{!! $employeecardb1->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="employee_1content">
    <h4>@lang('employeecardb1::lang.employee_1')</h4>
    <p>{{ $employeecardb1->employee1->first_name . ' ' . $employeecardb1->employee1->last_name }}</p>
</div>
        <!-- Additional Sections -->
        ...
        <div class="profile-section" id="createdatcontent">
            ...
            <p>{{ $employeecardb1->created_at }}</p>
        </div>

        <!-- QR Code Section -->
        <div class="profile-section" id="qrcontent">
            <h4>@lang('employeecardb1::lang.qrcode')</h4>
