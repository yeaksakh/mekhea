<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        {!! Form::open(['url' => action([\Modules\EmployeeCardB1\Http\Controllers\EmployeeCardB1Controller::class, 'store']), 'method' => 'post', 'id' => 'add_EmployeeCardB1_form' ]) !!}
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">@lang('employeecardb1::lang.add_EmployeeCardB1')</h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="employeecardb1_category_id" name="employeecardb1_category_id" style="width: 100%;">
