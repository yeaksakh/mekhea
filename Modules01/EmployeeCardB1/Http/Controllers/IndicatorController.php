...
use Modules\EmployeeCardB1\Entities\VisaIndicator;
use Modules\EmployeeCardB1\Entities\VisaCompetency;
use Modules\EmployeeCardB1\Entities\VisaAppraisalScore;
...
class IndicatorController extends Controller
{
    ...
    public function index()
    {
        ...
        ->addColumn('action', function ($indicator) {
            $html = '<div class="btn-group">
                ...
                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                    <li>
                        <a href="' . route('visa.indicator.view', $indicator->id) . '">
                            <i class="fas fa-eye"></i> ' . __('visa::lang.view') . '
                        </a>
                    </li>
                    <li>
                        <a href="' . route('visa.indicator.edit', $indicator->id) . '">
                            <i class="fas fa-pencil-alt"></i> ' . __('visa::lang.edit') . '
                        </a>
                    </li>
                    <li class="divider"></li>
                    <li>
                        <a href="#" data-href="' . route('visa.indicator.delete', $indicator->id) . '" class="delete_indicator">
                            <i class="fas fa-trash"></i> ' . __('visa::lang.delete') . '
                        </a>
                    </li>
                </ul>
            </div>';
        ...
        return view('visa::Indicator.index', compact('indicators'));
    }
    ...
    public function create()
    {
        ...
        return view('visa::Indicator.create', compact('department', 'designation'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('visa.indicator.index')->with('success', 'Indicator created successfully');
    }
    ...
    public function view($id)
    {
        ...
        return view('visa::Indicator.view_indicator', compact('indicator', 'department', 'designation'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('visa::Indicator.edit', compact('indicator', 'department', 'designation'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('visa.indicator.index')->with('success', 'Indicator updated successfully');
    }
    ...
    public function give_appraisal($id, Request $request)
    {
        ...
        return view('visa::Indicator.give_appraisal', compact('contact','indicator', 'department', 'designation', 'employee', 'appraisalss', 'scores'));
    }
    ...
    public function store_appraisal(Request $request, $id)
    {
        ...
        return redirect()->route('visa.indicator.index')->with('success', 'Appraisal saved successfully');
    }
    ...
    public function appraisal(Request $request)
    {
        ...
        return view('visa::Indicator.appraisal', compact('contact','indicators', 'indicator', 'department', 'designation', 'employee', 'appraisalss', 'scores', 'selectedIndicator'));
    }
    ...
    public function appraisal_list(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($appraisals)
                ...
                ->addColumn('action', function ($row) {
                    $viewUrl = route('visa.appraisal.view', ['id' => $row->id]);
                    $editUrl = route('visa.appraisal.store') . '?indicator=' . $row->indicator_id . '&appraisal_month=' . $row->appraisal_month .'&appraisal_id=' . $row->id;
                    if ($row->contact) {
                        $editUrl .= '&contact=' . $row->contact->id;
                    }
                    $deleteUrl = route('visa.appraisal.delete', ['appraisal_id' => $row->id]);
        ...
        return view('visa::Indicator.list_appraisal');
    }
    ...
    public function appraisal_view(Request $request, $id)
{
    ...
    $appraisalData = VisaAppraisal::from('visa_appraisals as a')
        ...
        return view('employeecardb1::user.partials.card.view_appraisal', compact('appraisalData'));
}
    ...
    public function appraisal_report(Request $request)
    {
        ...
        return view('visa::Indicator.report');
    }
    public function delete($id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('visa.indicator.index')->with('success', 'Indicator successfully deleted');
        } catch (\Exception $e) {
            DB::rollBack();
            return redirect()->route('visa.indicator.index')->with('error', 'Error deleting indicator: ' . $e->getMessage());
        }
    }
