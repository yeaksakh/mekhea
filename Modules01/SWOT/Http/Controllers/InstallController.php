...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'swot';
        $this->appVersion = config('swot.module_version');
        $this->module_display_name = 'SWOT';
    }
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => 'SWOT', '--force' => true]);
            System::addProperty($this->module_name . '_version', $this->appVersion);
        }

        $action_url = action([\Modules\SWOT\Http\Controllers\InstallController::class, 'install']);
        $intruction_type = 'uf';
        $action_type = 'install';
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = [
                'success' => 1,
                'msg' => 'SWOT module updated successfully to version ' . $this->appVersion . ' !!',
            ];
    ...
    public function install()
    {
        try {
            ...
            Artisan::call('migrate', [
                '--path' => 'Modules/SWOT/Database/Migrations',
                '--force' => true
            ]);

            // Publish module assets or configurations
            Artisan::call('module:publish', ['module' => 'SWOT']);

            // Optimize the application clearing cache
            Artisan::call('optimize:clear');

            $output = ['success' => 1, 'msg' => 'SWOT module installed successfully'];
        } catch (\Exception $e) {
