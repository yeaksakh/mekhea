...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'productdoc';
        $this->appVersion = config('productdoc.module_version');
        $this->module_display_name = 'ProductDoc';
    }
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => 'ProductDoc', '--force' => true]);
            System::addProperty($this->module_name . '_version', $this->appVersion);
        }

        $action_url = action([\Modules\ProductDoc\Http\Controllers\InstallController::class, 'install']);
        $intruction_type = 'uf';
        $action_type = 'install';
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = [
                'success' => 1,
                'msg' => 'ProductDoc module updated successfully to version ' . $this->appVersion . ' !!',
            ];
    ...
    public function install()
    {
        try {
            ...
            Artisan::call('migrate', [
                '--path' => 'Modules/ProductDoc/Database/Migrations',
                '--force' => true
            ]);

            // Publish module assets or configurations
            Artisan::call('module:publish', ['module' => 'ProductDoc']);

            // Optimize the application clearing cache
            Artisan::call('optimize:clear');

            $output = ['success' => 1, 'msg' => 'ProductDoc module installed successfully'];
        } catch (\Exception $e) {
