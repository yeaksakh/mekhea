...
namespace Modules\ProductDoc\Providers;
...
class ProductDocServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'ProductDoc';
    protected string $moduleNameLower = 'productdoc';

    protected $middleware = [
        'ProductDoc' => [
            'ProductDocLanguage' => 'ModuleLanguageMiddleware',
        ],
    ];
