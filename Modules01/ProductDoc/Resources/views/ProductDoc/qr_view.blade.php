<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('productdoc::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/ProductDocCategory/' . basename($productdoc->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/ProductDocCategory/' . basename($productdoc->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $productdoc->category->name }}</h3>
                <p>{!! $productdoc->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="Product_1content">
    <h4>@lang('productdoc::lang.Product_1')</h4>
    <p>{{ $productdoc->Product1->name }}</p>
</div>
<div class="profile-section" id="productFile1_5content">
    <h4>@lang('productdoc::lang.productFile1_5')</h4>
    <div class="profile-image">
        <img src="{{ asset('uploads/ProductDoc/' . $productdoc->productFile1_5) }}" alt="Document Image">
    </div>
</div>
<div class="profile-section" id="productFile2_6content">
    <h4>@lang('productdoc::lang.productFile2_6')</h4>
    <div class="profile-image">
        <img src="{{ asset('uploads/ProductDoc/' . $productdoc->productFile2_6) }}" alt="Document Image">
    </div>
</div>
<div class="profile-section" id="productFile3_7content">
    <h4>@lang('productdoc::lang.productFile3_7')</h4>
    <div class="profile-image">
        <img src="{{ asset('uploads/ProductDoc/' . $productdoc->productFile3_7) }}" alt="Document Image">
    </div>
</div>
<div class="profile-section" id="productFile4_8content">
    <h4>@lang('productdoc::lang.productFile4_8')</h4>
    <div class="profile-image">
        <img src="{{ asset('uploads/ProductDoc/' . $productdoc->productFile4_8) }}" alt="Document Image">
    </div>
</div>
        <!-- Additional Sections -->
        ...
        <div class="profile-section" id="createdatcontent">
            ...
            <p>{{ $productdoc->created_at }}</p>
        </div>

        <!-- QR Code Section -->
        <div class="profile-section" id="qrcontent">
            <h4>@lang('productdoc::lang.qrcode')</h4>
