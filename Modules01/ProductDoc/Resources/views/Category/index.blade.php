    ...
    <section class="content no-print">
        <div class="box box-solid">
            <div class="box-header with-border">
                <h5 class="box-title">
                    @lang('productdoc::lang.all_category')
                </h5>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-sm btn-primary btn-modal" data-href="{{ route('ProductDoc-categories.create') }}" data-container=".category_modal">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="categories_table">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>@lang('productdoc::lang.name')</th>
                                <th>@lang('productdoc::lang.image')</th>
                                <th>@lang('productdoc::lang.description')</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#categories_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ action([\Modules\ProductDoc\Http\Controllers\ProductDocController::class, 'getCategories']) }}",
                },
                order: [[1, 'desc']],
                columns: [
                    {
