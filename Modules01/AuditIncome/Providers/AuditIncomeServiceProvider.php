...
namespace Modules\AuditIncome\Providers;
...
class AuditIncomeServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'AuditIncome';
    protected string $moduleNameLower = 'auditincome';

    protected $middleware = [
        'AuditIncome' => [
            'AuditIncomeLanguage' => 'ModuleLanguageMiddleware',
        ],
    ];
