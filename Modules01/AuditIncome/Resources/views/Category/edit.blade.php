...
<div class="modal-content">
    ...
    <div class="modal-body">
        {!! Form::model($category, ['url' => action([\Modules\AuditIncome\Http\Controllers\AuditIncomeController::class, 'updateCategory'], $category->id), 'method' => 'put', 'id' => 'category_edit_form' ]) !!}
        <div class="form-group">
            {!! Form::label('name', __('auditincome::lang.name') . ':*') !!}
            {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => __('auditincome::lang.category_name')]) !!}
        </div>
        <div class="form-group">
            {!! Form::label('image', __('auditincome::lang.image') . ':') !!}
            {!! Form::file('image', [
                'id' => 'image',
            ...
            @if($category->{'image'})
                @php
                    ...
                    $filePath = 'uploads/AuditIncomeCategory/' . basename($category->{'image'});
                @endphp
        ...
        <div class="form-group">
            {!! Form::label('description', __('auditincome::lang.description') . ':') !!}
            {!! Form::textarea('description', null, ['class' => 'form-control','id'=>'summernote', 'placeholder' => __('auditincome::lang.description'), 'rows' => 3]) !!}
        </div>
