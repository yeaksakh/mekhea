...
<div class="col-md-3">
    <div class="form-group">
        {!! Form::label('address', __('report.address') . ':') !!}
        {!! Form::text('address', null, ['placeholder' => __('lang_v1.select_a_address'), 'class' => 'form-control', 'id' => 'address']); !!}
    </div>
</div>