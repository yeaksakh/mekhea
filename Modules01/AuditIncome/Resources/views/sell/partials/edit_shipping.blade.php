<div class="modal-dialog" role="document">
	...
	<div class="modal-content">
		...
		<div class="modal-footer">
			<button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-lg tw-text-white" style="background-color: #006400;">@lang('messages.update')</button>
		    <button type="button" class="tw-dw-btn tw-dw-btn-danger tw-dw-btn-lg tw-text-white"style="background-color: #FF0000;" data-dismiss="modal">@lang('messages.cancel')</button>
		</div>
