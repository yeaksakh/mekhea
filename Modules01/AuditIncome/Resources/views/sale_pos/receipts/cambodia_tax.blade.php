...
<div class="row" style="color: #000000 !important;">
    <div class="col-xs-12">
        <div class="header-container">
            <table class="table-auto w-full text-center width: 20%;">
                <tr>
                    @if(!empty($receipt_details->logo))
    <td class="align-top" style="vertical-align: top;">
        <img style="max-height: 100px; width: auto;" src="{{$receipt_details->logo}}" class="img img-responsive mx-auto">
    </td>
@endif

                    <td style="width: 80%;​ white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"> 
	...
	@endif
        ...
        <table class="table table-bordered table-invoice" style="font-size: 12px;">
            ...
            <tfoot>
			    ...
			    $converted_total = $sanitized_total * $exchange_rate;
	
		@endphp

		<td class="bold-text">
		   KHR {{ $total ? number_format($converted_total, 2, ',', ',') : 0 }} 
		</td>
