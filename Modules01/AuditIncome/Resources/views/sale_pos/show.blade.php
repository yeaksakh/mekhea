  ...
  <div class="modal-content">
    <div class="modal-header">
      <div class="modal-header d-flex justify-content-end align-items-center">
        ...
        <div class="d-flex align-items-center me-2">
          ...
          <a href="#"
            class="print-invoice tw-dw-btn tw-dw-btn-success tw-text-white rounded-start"
          ...
          <div class="btn-group">
    <button type="button"
        class="tw-dw-btn tw-dw-btn-success tw-text-white dropdown-toggle rounded-end"
    ...
    <div class="dropdown-menu dropdown-menu-end">
        @foreach($invoice_layouts as $id => $layout)
            <a class="dropdown-item print-invoice" href="#"
                data-href="{{ route('sell.printInvoice', [$sell->id]) }}?id={{ $id }}">
    ...
    <a href="{{ action([\App\Http\Controllers\InvoiceSchemeController::class, 'index']) }}" 
       class="tw-dw-btn tw-border-none tw-px-1 tw-py-1 tw-text-sm tw-w-full">
        <i class="fa fa-plus" aria-hidden="true"></i>
        @lang('invoice.invoice_layout')
    </a>
</div>
        ...
        <a class="dropdown-item print-invoice" href="#"
            data-href="{{ route('sell.printInvoice', [$sell->id]) }}?delivery_note=true">
            <i class="fas fa-file-alt" aria-hidden="true"></i>
            @lang("lang_v1.delivery_note")
        </a>
        <a class="dropdown-item print-invoice" href="#"
            data-href="{{ route('sell.printInvoice', [$sell->id]) }}?loan=true">
            <i class="fas fa-file-alt" aria-hidden="true"></i>
            @lang("sale.loan")
        </a>
        <a class="dropdown-item print-invoice" href="#"
            data-href="{{ route('sell.printInvoice', [$sell->id]) }}?invoice1=true">
            <i class="fas fa-file-alt" aria-hidden="true"></i>
            @lang("sale.invoice1")
        </a>
        <a class="dropdown-item print-invoice" href="#"
            data-href="{{ route('sell.printInvoice', [$sell->id]) }}?invoice2=true">
            <i class="fas fa-file-alt" aria-hidden="true"></i>
            @lang("sale.invoice2")
        </a>
       
        <a class="dropdown-item print-invoice" href="#"
            data-href="{{ route('sell.printInvoice', [$sell->id]) }}?cambodia_no_tax=true">
            <i class="fas fa-users" aria-hidden="true"></i>
            @lang("sale.cambodia_no_tax")
        </a>
        <a class="dropdown-item print-invoice" href="#"
            data-href="{{ route('sell.printInvoice', [$sell->id]) }}?cambodia_tax=true">
            <i class="fas fa-percent" aria-hidden="true"></i>
            @lang("sale.cambodia_tax")
        </a>
        ...
        <!-- Close Button -->
        <button type="button" class=" tw-dw-btn tw-dw-btn-neutral tw-text-white no-print" data-dismiss="modal" style="border-radius: 10px 10px 10px 10px !important;">
          @lang('messages.close')
        </button>
      </div>
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="@if(!empty($export_custom_fields)) col-sm-3 @else col-sm-4 @endif">
            <p><b>@lang('messages.date'):</b> {{ @format_date($sell->transaction_date) }}</p>
            ...
            @endif
            <br><strong>{{ __('lang_v1.commission_agent') }}:</strong> @if(!empty($commission_agent)){{$commission_agent->first_name }} {{$commission_agent->last_name }}
        	@endif
      ...
      <div>
        <h3 style="background-color: green; padding: 10px 20px; color: white;">Activities</h3>
        @php
