...
$(document).on('change', '#sell_list_filter_location_id, #sell_list_filter_customer_id, #sell_list_filter_payment_status, #created_by, #sales_cmsn_agnt, #service_staffs, #shipping_status, #audit_status',  function() {
    sell_table.ajax.reload();
});
...
sell_table = $('#sell_table').DataTable({
        ...
        columns: [
            ...
            { data: 'contact_group', name: 'contact_group'},
