		...
		<div class="form-group">
			...
			<div class="input-group">
				<span class="input-group-addon">
					<i class="text-success fas fa-hand-holding-usd"></i>
				</span>
	...
	<div class="col-md-12">
		<div class="form-group @if($readonly) hide @endif">
			...
			<div class="input-group">
				...
				<span class="input-group-addon" onclick="window.location.href='{{ action([\App\Http\Controllers\AccountController::class, 'index']) }}'" style="cursor: pointer; background-color: green; color: white; padding: 6px 12px; border-radius: 4px;">  
