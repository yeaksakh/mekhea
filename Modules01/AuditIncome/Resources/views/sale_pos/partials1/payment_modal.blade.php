<div class="modal fade" tabindex="-1" role="dialog" id="modal_payment">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="tw-dw-btn tw-dw-btn-success tw-text-white tw-dw-btn-sm tw-w-full"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <i class="text-success fas fa-door-open"></i>
                                                    </span>
                                                    @php
                                        ...
                                        @if (!empty($accounts))
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="text-success fas fa-calculator"></i>
                                                        </span>
                                                        {!! Form::select(
    ...
    <div class="form-group">
        {!! Form::label('sale_note', __('កំណត់ត្រា') . ':', ['style' => 'font-size: 50px;']) !!}

        {!! Form::textarea('sale_note', !empty($transaction) ? $transaction->additional_notes : null, [
            'class' => 'form-control text-placeholder-center',
            'style' => 'font-size: 25px; height: 200px; text-align: center;',
            'placeholder' => __('ដឹកទៅភ្នំពេញ'),
        ]) !!}
    </div>
</div> 
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="tw-dw-btn tw-dw-btn-success tw-text-white" id="pos-save">@lang('sale.finalize_payment')</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="card_details_modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="tw-dw-btn tw-dw-btn-success tw-text-white" id="pos-save-card">@lang('sale.finalize_payment')</button>
            </div>
        </div>
    </div>
</div>