				...
				<div class="row">
					...
					<div class="col-md-6">
				        <div class="form-group">
				            ...
				            {!! Form::textarea('shipping_details_modal', !empty($transaction->shipping_details) ? $transaction->shipping_details : '', ['class' => 'form-control','placeholder' => __('sale.shipping_details') ,'rows' => '4']); !!}
				        </div>
				    </div>
