@php
    ...
    $status = in_array($sub_status, ['quotation', 'consignment', 'proforma']) ? $sub_status : $status;
    $final_total = $attributes['final_total'] ?? 0;

    $old_status = $old['status'] ?? '';
    $old_sub_status = $old['sub_status'] ?? '';
    $old_shipping_status = $old['shipping_status'] ?? '';
    $old_status = in_array($old_sub_status, ['quotation', 'consignment', 'proforma']) ? $old_sub_status : $old_status;
