@extends('layouts.app')
@section('title', __( 'lang_v1.consignment'))
@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('lang_v1.list_consignments')
        <small></small>
    </h1>
</section>
...
<section class="content no-print">
	...
	<div class="col-md-3">
	    <div class="form-group">
	        {!! Form::label('audit_statuses', __('lang_v1.audit_status') . ':') !!}
        ...
        @slot('tool')
            <div class="box-tools">
                ...
                <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right"
                    href="{{action([\App\Http\Controllers\SellController::class, 'create'], ['status' => 'consignment'])}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        ...
                        <path d="M12 5l0 14" />
                        <path d="M5 12l14 0" />
                    </svg> @lang('lang_v1.add_consignment')
                </a>
            </div>
        @endslot
