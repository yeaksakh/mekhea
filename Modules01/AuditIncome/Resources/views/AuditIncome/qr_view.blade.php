<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('auditincome::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/AuditIncomeCategory/' . basename($auditincome->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/AuditIncomeCategory/' . basename($auditincome->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $auditincome->category->name }}</h3>
                <p>{!! $auditincome->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="IncomeSource_1content">
    <h4>@lang('auditincome::lang.IncomeSource_1')</h4>
    <p>{{ $auditincome->IncomeSource_1 }}</p>
</div>
<div class="profile-section" id="Amount_2content">
    <h4>@lang('auditincome::lang.Amount_2')</h4>
    <p>{{ $auditincome->Amount_2 }}</p>
</div>
        <!-- Additional Sections -->
        ...
        <div class="profile-section" id="createdatcontent">
            ...
            <p>{{ $auditincome->created_at }}</p>
        </div>

        <!-- QR Code Section -->
        <div class="profile-section" id="qrcontent">
            <h4>@lang('auditincome::lang.qrcode')</h4>
