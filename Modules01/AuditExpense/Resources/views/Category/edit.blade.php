...
<div class="modal-content">
    ...
    <div class="modal-body">
        {!! Form::model($category, ['url' => action([\Modules\AuditExpense\Http\Controllers\AuditExpenseController::class, 'updateCategory'], $category->id), 'method' => 'put', 'id' => 'category_edit_form' ]) !!}
        <div class="form-group">
            {!! Form::label('name', __('auditexpense::lang.name') . ':*') !!}
            {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => __('auditexpense::lang.category_name')]) !!}
        </div>
        <div class="form-group">
            {!! Form::label('image', __('auditexpense::lang.image') . ':') !!}
            {!! Form::file('image', [
                'id' => 'image',
            ...
            @if($category->{'image'})
                @php
                    ...
                    $filePath = 'uploads/AuditExpenseCategory/' . basename($category->{'image'});
                @endphp
        ...
        <div class="form-group">
            {!! Form::label('description', __('auditexpense::lang.description') . ':') !!}
            {!! Form::textarea('description', null, ['class' => 'form-control','id'=>'summernote', 'placeholder' => __('auditexpense::lang.description'), 'rows' => 3]) !!}
        </div>
