<div class="container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h2 class="header-title">@lang('auditexpense::lang.details')</h2>
    ...
    <div class="profile-card" id="print-content">
        ...
        <div class="profile-section" id="categorycontent">
            ...
            <div class="profile-image">
                <img src="{{ asset('uploads/AuditExpenseCategory/' . basename($auditexpense->category->image)) }}" alt="Document Image">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="profile-image">
                <a href="{{ asset('uploads/AuditExpenseCategory/' . basename($auditexpense->category->image)) }}" target="_blank">
                    <i class="fas fa-file-pdf"></i>
                </a>
            </div>
            @endif
            <div class="profile-info">
                <h3>{{ $auditexpense->category->name }}</h3>
                <p>{!! $auditexpense->category->description !!}</p>
            </div>
            @endif
        </div>
        <div class="profile-section" id="ExpenseSource_1content">
    <h4>@lang('auditexpense::lang.ExpenseSource_1')</h4>
    <p>{{ $auditexpense->ExpenseSource_1 }}</p>
</div>
<div class="profile-section" id="Amount_2content">
    <h4>@lang('auditexpense::lang.Amount_2')</h4>
    <p>{{ $auditexpense->Amount_2 }}</p>
</div>
        <!-- Additional Sections -->
        ...
        <div class="profile-section" id="createdatcontent">
            ...
            <p>{{ $auditexpense->created_at }}</p>
        </div>

        <!-- QR Code Section -->
        <div class="profile-section" id="qrcontent">
            <h4>@lang('auditexpense::lang.qrcode')</h4>
