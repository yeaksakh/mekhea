...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'auditexpense';
        $this->appVersion = config('auditexpense.module_version');
        $this->module_display_name = 'AuditExpense';
    }
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => 'AuditExpense', '--force' => true]);
            System::addProperty($this->module_name . '_version', $this->appVersion);
        }

        $action_url = action([\Modules\AuditExpense\Http\Controllers\InstallController::class, 'install']);
        $intruction_type = 'uf';
        $action_type = 'install';
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = [
                'success' => 1,
                'msg' => 'AuditExpense module updated successfully to version ' . $this->appVersion . ' !!',
            ];
    ...
    public function install()
    {
        try {
            ...
            Artisan::call('migrate', [
                '--path' => 'Modules/AuditExpense/Database/Migrations',
                '--force' => true
            ]);

            // Publish module assets or configurations
            Artisan::call('module:publish', ['module' => 'AuditExpense']);

            // Optimize the application clearing cache
            Artisan::call('optimize:clear');

            $output = ['success' => 1, 'msg' => 'AuditExpense module installed successfully'];
        } catch (\Exception $e) {
