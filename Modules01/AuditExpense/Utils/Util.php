    ...
    public function getInvoiceUrl($transaction_id, $business_id)
{
    ...
    return route('show_invoice', ['token' => $transaction->invoice_token]) . '?' . http_build_query($params);
}
    ...
    public function audit_statuses()
    {
        $statuses = [
            'pending' => __('lang_v1.pending'),
            'no_receipt' => __('lang_v1.no_receipt'),
            'confused' => __('lang_v1.confused'),
            'money' => __('lang_v1.money'),
    ...
    public function createUser($request)
    {
        $user_details = $request->only([
            ...
            'custom_field_2', 'custom_field_3', 'custom_field_4', 'guardian_name', 'id_proof_name', 'id_proof_number', 'permanent_address', 'current_address', 'bank_details', 'selected_contacts', 'is_enable_service_staff_pin', 'service_staff_pin','name_in_khmer','crm_department', 'crm_designation',
    'uniform_size',
    'member_date',
    'hieght', 
    'weight', 
