...
namespace Modules\CustomerStock\Providers;
...
class CustomerStockServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'CustomerStock';
    protected string $moduleNameLower = 'customerstock';

    protected $middleware = [
        'CustomerStock' => [
            'CustomerStockLanguage' => 'ModuleLanguageMiddleware',
        ],
    ];
