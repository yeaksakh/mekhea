...
<div class="modal-content">
    ...
    <div class="modal-body">
        {!! Form::model($category, ['url' => action([\Modules\CustomerStock\Http\Controllers\CustomerStockController::class, 'updateCategory'], $category->id), 'method' => 'put', 'id' => 'category_edit_form' ]) !!}
        <div class="form-group">
            {!! Form::label('name', __('customerstock::lang.name') . ':*') !!}
            {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => __('customerstock::lang.category_name')]) !!}
        </div>
        <div class="form-group">
            {!! Form::label('image', __('customerstock::lang.image') . ':') !!}
            {!! Form::file('image', [
                'id' => 'image',
            ...
            @if($category->{'image'})
                @php
                    ...
                    $filePath = 'uploads/CustomerStockCategory/' . basename($category->{'image'});
                @endphp
        ...
        <div class="form-group">
            {!! Form::label('description', __('customerstock::lang.description') . ':') !!}
            {!! Form::textarea('description', null, ['class' => 'form-control','id'=>'summernote', 'placeholder' => __('customerstock::lang.description'), 'rows' => 3]) !!}
        </div>
